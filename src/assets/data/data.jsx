...
export const services = [
   {
      ...
      icon: <Ri24HoursLine />,
      content:
         " We are 24/7 available to your service as that is what we are here for. Anytime you need something just call and sit back while everything is being done for you.",
   },
   {
      id: 2,
      icon: <FaTruck />,
      content:
         " We also offer delivery services for customers. This includes our fast motorbike couriers and also professional truck drivers for those with much products that might require shipping.",
   },
   {
      id: 3,
      icon: <RiMoneyDollarCircleLine />,
      content:
         " For people not satisfied by our services, we have also the refund and return services for them to get back their money or request for another product of the same type.",
   },
   {
      id: 4,
      icon: <RiSecurePaymentLine />,
      content:
         " All payment methods are secure with our services because we have insurance from different companies and our tech staff are very experienced with money transfer security.",
   },
];
...
export const extraServices = [
   {
      ...
      image: service01,
      content:
         " We are not just a fast food restaurant for delivering but we also provide restaurant services. So for those who want to grap dinner you're all welcome.",
   },
   {
      id: 2,
      image: service02,
      content:
         " Our staff is very experienced when it becomes to making ravishing dishes that can make your mouth salivary. Services are so quick and special so don't hesitate to come.",
   },
];
